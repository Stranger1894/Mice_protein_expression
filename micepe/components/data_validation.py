...
import numpy as np
from micepe.config import TARGET_COLUMN
...
class DataValidation:
    ...
    def initiate_data_validation(self)->artifact_entity.DataValidationArtifact:
        try:
            ...
            base_df = pd.read_excel(self.data_validation_config.base_file_path, index_col = "MouseID")
            logging.info(f"Dropping columns Genotype, Treatment and Behavior")
            base_df = base_df.drop(['Genotype','Treatment','Behavior'],axis=1)
